...
cv2.imwrite("C:\\Users\\yuktanidhi\\Downloads\\Sign-Language-To-Text-and-Speech-Conversion-master\\white.jpg",white)
...
while True:
    try:
        ...
        if hands:
            ...
            x, y, w, h = hand['bbox']
            image = frame[y - offset:y + h + offset, x - offset:x + w + offset]
            white = cv2.imread("C:\\Users\\yuktanidhi\\Downloads\\Sign-Language-To-Text-and-Speech-Conversion-master\\white.jpg")
            # img_final=img_final1=img_final2=0
